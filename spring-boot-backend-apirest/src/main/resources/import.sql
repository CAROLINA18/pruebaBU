...
INSERT INTO clientes (region_id, nombre, apellido, email, create_at) VALUES(1, 'Ana Carolina', 'Aristizabal', 'ana@yopmail.com', '2018-01-01');
...
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('ana','$2a$10$C3Uln5uqnzx/GswADURJGOIdBqYrly9731fnwKDaUdBkt/M3qvtLq',1, 'Ana', 'Aristizabal','ana@yopmail.com');
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$RmdEsvEfhI7Rcm9f/uZXPebZVCcPC7ZXZwV51efAvMAp1rIaRAfPK',1, 'John', 'Doe','jhon.doe@yopmail.com');
